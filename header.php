...
<head>
    ...
    <title>OS Trainer | Open Source Education Center</title>
                    ...
                    <div class="content_wrap clearfix">
                        ...
                        <div class="logo">
                            <a href="index.html">
								...
								<img src="images/ostrainer_logo.png" class="logo_fixed" alt="">
							</a>
                        </div>
						<!-- Logo -->
						<!-- Search -->
						...
						<nav class="menu_main_nav_area">
							<ul id="menu_main" class="menu_main_nav">
								<li class="menu-item menu-item-has-children current-menu-ancestor current-menu-parent"><a href="index.php">Home</a>
								</li>
								...
								<li class="menu-item menu-item-has-children"><a href="#">Courses</a>
									<ul class="sub-menu">
										<li class="menu-item"><a href="#">Full Stack Developer</a></li>
										<li class="menu-item"><a href="#">Android Developer</a></li>
										<li class="menu-item"><a href="#">PHP Developer</a></li>
